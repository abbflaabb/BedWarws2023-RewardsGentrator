...
public class Messages {
    ...
    // XP Rewards Settings
    public static final String XP_DIAMOND_ENABLED = PATH + "xp-rewards.diamond-collect.enabled";
    public static final String XP_DIAMOND_AMOUNT = PATH + "xp-rewards.diamond-collect.amount";
    public static final String XP_EMERALD_ENABLED = PATH + "xp-rewards.emerald-collect.enabled";
    public static final String XP_EMERALD_AMOUNT = PATH + "xp-rewards.emerald-collect.amount";

    // Lucky Boost Settings
    public static final String LUCKY_BOOST_ENABLED = PATH + "lucky-boost.enabled";
    public static final String LUCKY_BOOST_CHANCE = PATH + "lucky-boost.chance";
    public static final String LUCKY_BOOST_DURATION = PATH + "lucky-boost.duration";
    public static final String LUCKY_BOOST_SOUND = PATH + "lucky-boost.sound-enabled";

    public static final String LUCKY_ON_START = PATH + "lucky-boost.on-game-start";
    public static final String LUCKY_ON_COLLECT = PATH + "lucky-boost.on-resource-collect";
    public static final String LUCKY_ON_KILL = PATH + "lucky-boost.on-kill";
    public static final String LUCKY_ON_LEVEL = PATH + "lucky-boost.on-level-up";

    // Boost Weights
    public static final String WEIGHT_DOUBLE = PATH + "lucky-boost.types.double-exp.weight";
    public static final String WEIGHT_TRIPLE = PATH + "lucky-boost.types.triple-exp.weight";
    public static final String WEIGHT_MEGA = PATH + "lucky-boost.types.mega-exp.weight";
    public static final String WEIGHT_ULTIMATE = PATH + "lucky-boost.types.ultimate-exp.weight";
    ...
    public static void setupMessages() {
        for (Language l : Language.getLanguages()) {
            ...
            // Default Settings (same for all languages)
            addDefault(l, XP_DIAMOND_ENABLED, true);
            addDefault(l, XP_DIAMOND_AMOUNT, 25);
            addDefault(l, XP_EMERALD_ENABLED, true);
            addDefault(l, XP_EMERALD_AMOUNT, 60);
            addDefault(l, LUCKY_BOOST_ENABLED, true);
            addDefault(l, LUCKY_BOOST_CHANCE, 0.05);
            addDefault(l, LUCKY_BOOST_DURATION, 60);
            addDefault(l, LUCKY_BOOST_SOUND, true);
            addDefault(l, LUCKY_ON_START, true);
            addDefault(l, LUCKY_ON_COLLECT, false);
            addDefault(l, LUCKY_ON_KILL, true);
            addDefault(l, LUCKY_ON_LEVEL, false);
            addDefault(l, WEIGHT_DOUBLE, 50.0);
            addDefault(l, WEIGHT_TRIPLE, 30.0);
            addDefault(l, WEIGHT_MEGA, 15.0);
            addDefault(l, WEIGHT_ULTIMATE, 5.0);
    ...
    private static void setupEnglish(Language l) {
        ...
        addDefault(l, DOUBLE_SUBTITLE, "&bYou will receive &b&lDOUBLE EXP &bthis game!");
        ...
        addDefault(l, TRIPLE_SUBTITLE, "&bYou will receive &d&lTRIPLE EXP &bthis game!");
        ...
        addDefault(l, MEGA_SUBTITLE, "&bYou will receive &6&lMEGA EXP &bthis game!");
        ...
        addDefault(l, ULTIMATE_SUBTITLE, "&bYou will receive &c&lULTIMATE EXP &bthis game!");
    ...
    private static void setupRomanian(Language l) {
        ...
        addDefault(l, LEVEL_UP, "&aAi crescut în nivel! Acum ești nivelul &e{level}&a!");
        addDefault(l, LUCKY_BOOST_EXPIRE, "&c&l✦ &6Lucky Boost-ul tău a expirat! &c&l✦");
        addDefault(l, DOUBLE_TITLE, "&6&lAI AVUT NOROC!");
        addDefault(l, DOUBLE_SUBTITLE, "&bVei primi &b&lDOUBLE EXP &bîn acest joc!");
        addDefault(l, DOUBLE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Ai primit &b&lDOUBLE EXP &7pentru &e{duration}s&7!");
        addDefault(l, TRIPLE_TITLE, "&d&lSUPER NOROC!");
        addDefault(l, TRIPLE_SUBTITLE, "&bVei primi &d&lTRIPLE EXP &bîn acest joc!");
        addDefault(l, TRIPLE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Ai primit &d&lTRIPLE EXP &7pentru &e{duration}s&7!");
        addDefault(l, MEGA_TITLE, "&6&lMEGA NOROC!");
        addDefault(l, MEGA_SUBTITLE, "&bVei primi &6&lMEGA EXP &bîn acest joc!");
        addDefault(l, MEGA_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Ai primit &6&lMEGA EXP &7pentru &e{duration}s&7!");
        addDefault(l, ULTIMATE_TITLE, "&c&lULTIMATE NOROC!");
        addDefault(l, ULTIMATE_SUBTITLE, "&bVei primi &c&lULTIMATE EXP &bîn acest joc!");
        addDefault(l, ULTIMATE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Ai primit &c&lULTIMATE EXP &7pentru &e{duration}s&7!");
    }

    private static void setupSpanish(Language l) {
        addDefault(l,XP_GAIN, "&a¡Ganaste &e{amount} XP por {source}!");
        ...
        addDefault(l,DOUBLE_TITLE, "&6&l¡QUÉ SUERTE!");
        addDefault(l,DOUBLE_SUBTITLE, "&b¡Recibirás &b&lDOBLE EXP &ben esta partida!");
        addDefault(l,DOUBLE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7¡Recibiste &b&lDOBLE EXP &7por &e{duration}s&7!");
        addDefault(l,TRIPLE_TITLE, "&d&l¡SUPER SUERTE!");
        addDefault(l,TRIPLE_SUBTITLE, "&b¡Recibirás &d&lTRIPLE EXP &ben esta partida!");
        addDefault(l,TRIPLE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7¡Recibiste &d&lTRIPLE EXP &7por &e{duration}s&7!");
        addDefault(l,MEGA_TITLE, "&6&l¡MEGA SUERTE!");
        addDefault(l,MEGA_SUBTITLE, "&b¡Recibirás &6&lMEGA EXP &ben esta partida!");
        addDefault(l,MEGA_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7¡Recibiste &6&lMEGA EXP &7por &e{duration}s&7!");
        addDefault(l,ULTIMATE_TITLE, "&c&l¡ULTIMATE SUERTE!");
        addDefault(l,ULTIMATE_SUBTITLE, "&b¡Recibirás &c&lULTIMATE EXP &ben esta partida!");
        addDefault(l,ULTIMATE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7¡Recibiste &c&lULTIMATE EXP &7por &e{duration}s&7!");
    }
    ...
    private static void setupPortuguese(Language l) {
        ...
        addDefault(l,DOUBLE_TITLE, "&6&lQUE SORTE!");
        addDefault(l,DOUBLE_SUBTITLE, "&bVocê receberá &b&lDOBRO DE EXP &bneste jogo!");
        addDefault(l,DOUBLE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Você recebeu &b&lDOBRO DE EXP &7por &e{duration}s&7!");
        addDefault(l,TRIPLE_TITLE, "&d&lSUPER SORTE!");
        addDefault(l,TRIPLE_SUBTITLE, "&bVocê receberá &d&lTRIPLO DE EXP &bneste jogo!");
        addDefault(l,TRIPLE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Você recebeu &d&lTRIPLO DE EXP &7por &e{duration}s&7!");
        ...
        addDefault(l,ULTIMATE_TITLE, "&c&lULTIMATE SORTE!");
        addDefault(l,ULTIMATE_SUBTITLE, "&bVocê receberá &c&lULTIMATE EXP &bneste jogo!");
        addDefault(l,ULTIMATE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Você recebeu &c&lULTIMATE EXP &7por &e{duration}s&7!");
    }
    ...
    private static void setupItalian(Language l) {
        ...
        addDefault(l,DOUBLE_TITLE, "&6&lCHE FORTUNA!");
        addDefault(l,DOUBLE_SUBTITLE, "&bRiceverai &b&lDOPPIA EXP &bin questa partita!");
        addDefault(l,DOUBLE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Hai ricevuto &b&lDOPPIA EXP &7per &e{duration}s&7!");
        addDefault(l,TRIPLE_TITLE, "&d&lSUPER FORTUNA!");
        addDefault(l,TRIPLE_SUBTITLE, "&bRiceverai &d&lTRIPLA EXP &bin questa partita!");
        addDefault(l,TRIPLE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Hai ricevuto &d&lTRIPLA EXP &7per &e{duration}s&7!");
        addDefault(l,MEGA_TITLE, "&6&lMEGA FORTUNA!");
        ...
        addDefault(l,ULTIMATE_TITLE, "&c&lULTIMATE FORTUNA!");
        addDefault(l,ULTIMATE_SUBTITLE, "&bRiceverai &c&lULTIMATE EXP &bin questa partita!");
        addDefault(l,ULTIMATE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Hai ricevuto &c&lULTIMATE EXP &7per &e{duration}s&7!");
    }

    private static void setupFrench(Language l) {
        addDefault(l,XP_GAIN, "&aVous avez gagné &e{amount} XP pour {source}!");
        addDefault(l,LEVEL_UP, "&aNiveau supérieur ! Vous êtes maintenant niveau &e{level}&a!");
        addDefault(l,LUCKY_BOOST_EXPIRE, "&c&l✦ &6Votre Lucky Boost a expiré ! &c&l✦");
        addDefault(l,DOUBLE_TITLE, "&6&lQUELLE CHANCE !");
        addDefault(l,DOUBLE_SUBTITLE, "&bVous recevrez &b&lDOUBLE EXP &bdans cette partie !");
        addDefault(l,DOUBLE_CHAT, "&a&l✦ &6Lucky Boost ! &a&l✦ &7Vous avez reçu &b&lDOUBLE EXP &7pendant &e{duration}s&7 !");
        addDefault(l,TRIPLE_TITLE, "&d&lSUPER CHANCE !");
        addDefault(l,TRIPLE_SUBTITLE, "&bVous recevrez &d&lTRIPLE EXP &bdans cette partie !");
        addDefault(l,TRIPLE_CHAT, "&a&l✦ &6Lucky Boost ! &a&l✦ &7Vous avez reçu &d&lTRIPLE EXP &7pendant &e{duration}s&7 !");
        addDefault(l,MEGA_TITLE, "&6&lMEGA CHANCE !");
        addDefault(l,MEGA_SUBTITLE, "&bVous recevrez &6&lMEGA EXP &bdans cette partie !");
        addDefault(l,MEGA_CHAT, "&a&l✦ &6Lucky Boost ! &a&l✦ &7Vous avez reçu &6&lMEGA EXP &7pendant &e{duration}s&7 !");
        addDefault(l,ULTIMATE_TITLE, "&c&lULTIMATE CHANCE !");
        addDefault(l,ULTIMATE_SUBTITLE, "&bVous recevrez &c&lULTIMATE EXP &bdans cette partie !");
        addDefault(l,ULTIMATE_CHAT, "&a&l✦ &6Lucky Boost ! &a&l✦ &7Vous avez reçu &c&lULTIMATE EXP &7pendant &e{duration}s&7 !");
    }

    private static void setupRussian(Language l) {
        addDefault(l, XP_GAIN, "&aВы получили &e{amount} опыта за {source}!");
        addDefault(l, LEVEL_UP, "&aНовый уровень! Теперь ваш уровень &e{level}&a!");
        addDefault(l, LUCKY_BOOST_EXPIRE, "&c&l✦ &6Ваш Lucky Boost истек! &c&l✦");
        ...
        addDefault(l, ULTIMATE_TITLE, "&c&lУЛЬТИМЕЙТ ВЕЗЕНИЕ!");
        addDefault(l, ULTIMATE_SUBTITLE, "&bВы получите &c&lУЛЬТИМЕЙТ ОПЫТ &bв этой игре!");
        addDefault(l, ULTIMATE_CHAT, "&a&l✦ &6Lucky Boost! &a&l✦ &7Вы получили &c&lУЛЬТИМЕЙТ ОПЫТ &7на &e{duration}с&7!");
    }
    ...
    private static void setupBengali(Language l) {
        addDefault(l,XP_GAIN, "&aআপনি {source} এর জন্য &e{amount} XP পেয়েছেন!");
        addDefault(l,LEVEL_UP, "&aআপনার লেভেল বেড়েছে! আপনি এখন লেভেল &e{level}&a!");
        addDefault(l,LUCKY_BOOST_EXPIRE, "&c&l✦ &6আপনার লাকি বুস্ট শেষ হয়ে গেছে! &c&l✦");
        addDefault(l,DOUBLE_TITLE, "&6&lআপনি ভাগ্যবান!");
        addDefault(l,DOUBLE_SUBTITLE, "&bআপনি এই গেমে &b&lDOUBLE EXP &bপাবেন!");
        addDefault(l,DOUBLE_CHAT, "&a&l✦ &6লাকি বুস্ট! &a&l✦ &7আপনি &e{duration}s &7এর জন্য &b&lDOUBLE EXP &7পেয়েছেন!");
        addDefault(l,TRIPLE_TITLE, "&d&lসুপার ভাগ্যবান!");
        addDefault(l,TRIPLE_SUBTITLE, "&bআপনি এই গেमे &d&lTRIPLE EXP &bপাবেন!");
        addDefault(l,TRIPLE_CHAT, "&a&l✦ &6লাকি বুস্ট! &a&l✦ &7আপনি &e{duration}s &7এর জন্য &d&lTRIPLE EXP &7পেয়েছেন!");
        addDefault(l,MEGA_TITLE, "&6&lমেগা ভাগ্যবান!");
        addDefault(l,MEGA_SUBTITLE, "&bআপনি এই গেমে &6&lMEGA EXP &bপাবেন!");
        addDefault(l,MEGA_CHAT, "&a&l✦ &6লাকি বুস্ট! &a&l✦ &7আপনি &e{duration}s &7এর জন্য &6&lMEGA EXP &7পেয়েছেন!");
        addDefault(l,ULTIMATE_TITLE, "&c&lচরম ভাগ্যবান!");
        addDefault(l,ULTIMATE_SUBTITLE, "&bআপনি এই গেমে &c&lULTIMATE EXP &bপাবেন!");
        addDefault(l,ULTIMATE_CHAT, "&a&l✦ &6লাকি বুস্ট! &a&l✦ &7আপনি &e{duration}s &7এর জন্য &c&lULTIMATE EXP &7পেয়েছেন!");
    }
